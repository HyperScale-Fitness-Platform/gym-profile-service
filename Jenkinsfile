pipeline {
    ...
    parameters {
        string(name: 'REPO_URL', defaultValue: 'https://github.com/HyperScale-Fitness-Platform/gym-profile-service', description: 'Git repository to build')
        string(name: 'REPO_BRANCH', defaultValue: 'main', description: 'Branch to checkout')
        string(name: 'DOCKER_IMAGE', defaultValue: 'ibrahim27501/gym-profile-service', description: 'Docker image repository (user/repo)')
